...
$(document).on("click", "p", function() {
  ...
  $.ajax({
    ...
    .then(function(data) {
      ...
      $("#notes").append("<input id='titleinput' name='title' placeholder='enter title here...'><hr>");
      // A textarea to add a new note body
      $("#notes").append("<textarea id='bodyinput' name='body' placeholder='enter a note...'></textarea><br>");
